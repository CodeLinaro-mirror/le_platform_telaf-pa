...
)
{
    switch (metric)
    {
        ...
        case TAF_PA_RADIO_SIGNAL_METRIC_SS:
            /* Telux doesn't expose a dedicated SS (signal strength) measurement type.
             * Map SS to RSSI for threshold/delta configuration purposes.
             */
            return tel::SignalStrengthMeasurementType::RSSI;
        default:
