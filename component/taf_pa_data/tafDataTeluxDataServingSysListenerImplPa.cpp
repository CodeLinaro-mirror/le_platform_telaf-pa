...
{
    SET_SDK_THREAD_NAME();
    TAF_PA_DEBUG("Roaming status changed: %d", status.isRoaming);
    ...
    taf_pa_result_t result = teluxPaData.PaGetPhoneIdFromSlotId(eventInfo.slotId, eventInfo.phoneId);
...
)
{
    ...
    case telux::common::ServiceStatus::SERVICE_AVAILABLE:
        TAF_PA_INFO("Serving System Manager for Slot ID %d: AVAILABLE", slotId_);
        state = taf::pa::data::SubsystemState_e::AVAILABLE;
        break;
    case telux::common::ServiceStatus::SERVICE_UNAVAILABLE:
        TAF_PA_ERROR("Serving System Manager for Slot ID %d: UNAVAILABLE", slotId_);
        state = taf::pa::data::SubsystemState_e::UNAVAILABLE;
        break;
    case telux::common::ServiceStatus::SERVICE_FAILED:
        TAF_PA_ERROR("Serving System Manager for Slot ID %d: FAILED", slotId_);
        state = taf::pa::data::SubsystemState_e::FAILED;
        break;
    default:
        TAF_PA_WARN("Serving System Manager for Slot ID %d: status unknown", slotId_);
        state = taf::pa::data::SubsystemState_e::FAILED;
        break;
    };
