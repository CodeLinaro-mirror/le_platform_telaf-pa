...
TAF_PROP_SHARED taf_prop_result_t taf_prop_radio_Init
(
    void
);

TAF_PROP_SHARED taf_prop_result_t taf_prop_radio_Deinit
(
    void
);

TAF_PROP_SHARED taf_prop_result_t taf_prop_radio_InitInstance
(
    uint32_t instance
);

TAF_PROP_SHARED taf_prop_result_t taf_prop_radio_RegisterIndication
(
    uint32_t instance,
...
TAF_PROP_SHARED taf_prop_result_t taf_prop_radio_SetSysInfoIndLimit
(
    uint32_t instance,
    taf_prop_radio_SysInfoIndLimitMask_t limitMask
);

TAF_PROP_SHARED taf_prop_result_t taf_prop_radio_GetServiceStatus
(
    uint32_t instance,
...
TAF_PROP_SHARED taf_prop_result_t taf_prop_radio_GetSysInfoIndLimit
(
    uint32_t instance,
    taf_prop_radio_SysInfoIndLimitMask_t *limitMask
);

TAF_PROP_SHARED taf_prop_result_t taf_prop_radio_PerformPciNetworkScan
(
    uint32_t instance,
...
TAF_PROP_SHARED taf_prop_result_t taf_prop_radio_GetServingRat
(
    uint32_t instance,
    taf_prop_radio_Rat_t* ratPtr
);

TAF_PROP_SHARED taf_prop_result_t taf_prop_radio_GetRatSvcStatus
(
    uint32_t instance,
    taf_prop_radio_Rat_t rat,
...
TAF_PROP_SHARED taf_prop_result_t taf_prop_radio_GetServingCellRac
(
    uint32_t instance,
    taf_prop_radio_Rat_t rat,
    uint8_t* racPtr
...
TAF_PROP_SHARED taf_prop_result_t taf_prop_radio_GetDataAvailSysStatus
(
    uint32_t instance,
    taf_prop_radio_DataAvailSysStatus_t* statusPtr
);

TAF_PROP_SHARED taf_prop_result_t taf_prop_radio_GetLteCphyCaInfo
(
    uint32_t instance,
    taf_prop_radio_LteCphyCaInfo_t* infoPtr
);

TAF_PROP_SHARED taf_prop_radio_RatSvcStatusHandlerRef_t taf_prop_radio_AddRatSvcStatusHandler
(
    uint32_t instance,
...
TAF_PROP_SHARED taf_prop_radio_LteCphyCaHandlerRef_t taf_prop_radio_AddLteCphyCaHandler
(
    uint32_t instance,
...
TAF_PROP_SHARED taf_prop_radio_DataAvailSysStatusHandlerRef_t taf_prop_radio_AddDataAvailSysStatusHandler
(
    uint32_t instance,
...
TAF_PROP_SHARED taf_prop_result_t taf_prop_radio_GetDataCurrRoamingStatus
(
    uint32_t instance,
